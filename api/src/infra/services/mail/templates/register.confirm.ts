export interface RegisterConfirmTemplateParams {
  dashboardUrl: string;
}

export const registerConfirmTemplate = (
  dashboardUrl: RegisterConfirmTemplateParams["dashboardUrl"], //TODO: make this URL dynamic based on the environment
): string => {
...
<head>
    ...
    <title>Bem-vindo à Tripay</title>
    <style>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 20px 40px 40px 40px;">
                            ...
                            <p class="mobile-text" style="color: #4a4a4a; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0; text-align: center;">
                                Olá! Ficamos muito felizes em tê-lo conosco. Sua conta foi criada com sucesso e você já pode começar a explorar todas as funcionalidades da nossa plataforma.
                            </p>
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                <td style="padding: 8px 0;">
                                                    <span class="mobile-text" style="color: #1a1a1a; font-size: 16px; font-weight: 400; display: block; text-align: center;">• Complete seu perfil no painel de controle</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0;">
                                            ...
                                            <tr>
                                                <td style="padding: 8px 0;">
                                                    <span class="mobile-text" style="color: #1a1a1a; font-size: 16px; font-weight: 400; display: block; text-align: center;">• Explore os recursos disponíveis</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0;">
                                                    <span class="mobile-text" style="color: #1a1a1a; font-size: 16px; font-weight: 400; display: block; text-align: center;">• Entre em contato conosco se precisar de ajuda</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <p class="mobile-text mobile-small-text" style="color: #6b7280; font-size: 14px; line-height: 1.5; margin: 20px 0 0 0; text-align: center;">
                                ...
                                <span style="color: #F51B31; word-break: break-all;">${dashboardUrl}</span>
                            </p>
                        </td>
                    </tr>
                    <tr>
